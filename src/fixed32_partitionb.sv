 ...
 * 
 * Description:
 * This a module to deal with the b partition of fixed32 look-up-
 * table (LUT).
 * 
...
module fixed32_partitionb #(
  parameter string INIT_FILE = {"fixed32_b_partition.", `SPEX_RAM_EXT},
...
// Final assignment
//=====================================================================================
assign o_exp_b = binary32_t'(s_o_exp_b_bits);
...
endmodule // module fixed32_partitionb #()
