...
module fixed128_64_partitionb_unit_test;
  ...
  string name = "fixed128_64_partitionb_ut";
...
initial begin
  ...
  localparam string A128_FILE = my_fixed128_64_partitionb.INIT_128_FILE;
  localparam string A64_FILE  = my_fixed128_64_partitionb.INIT_64_FILE;
