`SVTEST(SINGLE_handwritten_sanity_correctness_test_0_exact)
...
`SVTEST(SINGLE_handwritten_sanity_correctness_test_0)
  logic [127:0] expected = 128'h3fffa61298e1e069bc972dfefab6df34; // 1.6487212707001281468486507878141635764
...
`SVTEST(SINGLE_handwritten_sanity_correctness_test_2)
...
`SVTEST(SINGLE_handwritten_sanity_correctness_test_3)
...
`SVTEST(SINGLE_handwritten_sanity_correctness_test_4)
...
`SVTEST(SINGLE_handwritten_sanity_correctness_test_5)
